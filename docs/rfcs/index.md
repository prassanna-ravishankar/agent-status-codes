...
Requests for Comments (RFCs) are the durable mechanism for proposing substantial
...
Use an RFC for a change that affects interoperability or the long-term contract,
including:
...
Small corrections, clearer wording, examples, and objective fixes can be made by
...
The authority that moves an RFC into a terminal state is **TBD** while the
project is young. Status changes must always be explicit in the RFC and its pull
request history.
